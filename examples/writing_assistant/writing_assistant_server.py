...
WRITING_SERVER_PORT = int(os.getenv("WRITING_SERVER_PORT", "8000"))

app = FastAPI(title="Writing Assistant Server", description="Simple middleware")

query_constructor = WritingAssistantQueryConstructor()
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host="0.0.0.0", port=WRITING_SERVER_PORT)