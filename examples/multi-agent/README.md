...
http://localhost:8501?user=user1
```
...
```
agents/
├── advisor_buddy_v3.py    # Main orchestrator (delegation tools)
...
### MemMachine Memory Tools (NEW! 🧠)
- **store_memory**: Store any conversation or fact
- **search_memories**: Search past conversations and preferences
