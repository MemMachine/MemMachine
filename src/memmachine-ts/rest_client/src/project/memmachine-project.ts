...
export class MemMachineProject {
  ...
  async create(options?: CreateProjectOptions): Promise<Project> {
    ...
    try {
      const response = await this.client.post('/api/v2/projects', payload)
  ...
  async get(): Promise<Project> {
    ...
    try {
      const response = await this.client.post('/api/v2/projects/get', payload)
      return response.data
    } catch (error: unknown) {
  ...
  async getEpisodicCount(): Promise<number> {
    ...
    try {
      const response = await this.client.post('/api/v2/projects/episode_count/get', payload)
  ...
  async delete(): Promise<null> {
    ...
    try {
      const response = await this.client.post('/api/v2/projects/delete', payload)
      return response.data
    } catch (error: unknown) {
