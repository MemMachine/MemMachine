 ...
 * {@link ClientOptions.timeout} is optional (default: 60000 ms).
 *
 * Features:
...
export class MemoryClient {
   ...
   */
  async addMemory(message: string, message_type: string, options: MemoryOptions): Promise<null> {
   ...
   * @throws {@link APIError} if the request fails or required fields are missing.
   */
  async addEpisodicMemory(message: string, message_type: string, options: MemoryOptions): Promise<null> {
   ...
   * @throws {@link APIError} if the request fails or required fields are missing.
   */
  async addProfileMemory(message: string, message_type: string, options: MemoryOptions): Promise<null> {
   ...
   * @throws {@link APIError} if the request fails or required fields are missing.
   */
  async deleteMemory(options: SessionOptions): Promise<null> {
  ...
  private _checkRequiredFields(fields: Array<{ value: unknown; name: string }>) {
