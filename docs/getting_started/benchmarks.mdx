...
**Note:** Although the process is simple, the commands for each type of Tool Set may differ.  Please refer to the [Episodic Memory Tool Set](./locomo/episodic_memory/README.md) for the exact commands to run for each step.
