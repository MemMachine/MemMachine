...
- **Graph Database** (choose one):
  ...
  - **NebulaGraph Enterprise**: An alternative to Neo4j with native vector support. See the [NebulaGraph Integration Guide](/docs/nebula_graph_integration_guide) for setup instructions.
