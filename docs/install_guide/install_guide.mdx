...
- **Graph Database** (choose one):
  ...
  - **NebulaGraph Enterprise 5.0+**: An alternative to Neo4j with native vector support. See the [NebulaGraph Integration Guide](/docs/nebula_graph_integration_guide) for setup instructions.
