...
You need NebulaGraph Enterprise 5.2.0 or later. NebulaGraph is designed to handle graphs with trillions of edges and vertices, NebulaGraph delivers millisecond latency at high concurrency, enabling real-time insights where performance matters most. 
...
```bash
pip install nebula5-python>=5.2.0
```
