...
| --------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| `memoryContext` | [`MemoryContext`](../interfaces/MemoryContext) | Optional scope settings to filter or categorize these memories. |
...
| `options` | [`SearchMemoryOptions`](../interfaces/SearchMemoryOptions) | Limits, filters, or minimum similarity scores. |

**Returns**

- `Promise<SearchMemoryResult>` — A list of relevant [EpisodeMemory](../interfaces/EpisodeMemory) objects.
...
| `type`   | [`MemoryType`](../type-aliases/MemoryType) | Specify either `episodic` or `semantic`.                     |
