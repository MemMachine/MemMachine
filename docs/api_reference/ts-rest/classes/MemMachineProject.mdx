...
| **Name**  | **Type**                                                     | **Description**                                  |
| --------- | ------------------------------------------------------------ | ------------------------------------------------ |
| `options` | [`CreateProjectOptions`](../interfaces/CreateProjectOptions) | Optional settings such as a project description. |
...
| **Name**        | **Type**                                                     | **Description**                              |
| --------------- | ------------------------------------------------------------ | -------------------------------------------- |
| `memoryContext` | [`MemoryContext`](../interfaces/MemoryContext) | Optional context to narrow the memory scope. |
...
const client = new MemMachineClient({ base_url: '[https://api.memmachine.com](https://api.memmachine.com)' });
