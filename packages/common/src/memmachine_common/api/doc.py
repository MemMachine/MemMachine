...
class SpecDoc:
    ...
    EVENT_MEMORY_SEGMENTER = (
        "Segmenter configuration (discriminated by `type`). "
        "Controls how events are split into segments."
    )
    EVENT_MEMORY_DERIVER = (
        "Deriver configuration (discriminated by `type`). "
        "Controls how segments are turned into derivatives for embedding."
    )
