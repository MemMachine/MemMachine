...
async def test_add_message_records_history_and_uningested_counts(
    ...
    await session_manager.add_message(
        session_data=session_data, episodes=episodes
    )
    ...
    assert list(profile_messages) == episodes
    assert list(session_messages) == episodes
...
async def test_get_set_features_wraps_opts(
    ...
    _ = mock_session_manager._generate_session_data(session_data=session_data)
