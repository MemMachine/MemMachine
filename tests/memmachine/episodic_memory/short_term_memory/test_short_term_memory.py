...
from memmachine.configuration.episodic_config import ShortTermMemoryParams, EpisodicMemoryParams
...
class MockShortTermMemoryDataManager(SessionDataManager):
    ...
    async def save_short_term_memory(
        self, session_key: str, summary: str, episodes: list[Episode], seq: int, num: int
    ):
        self.data[session_key] = (summary, episodes, seq, num)
