...
from memmachine.server.api_v2.config_router import get_resource_manager
...
def client(mock_memmachine):
    ...
    app = MemMachineAPI()
    app.dependency_overrides[get_resource_manager] = (
        lambda: mock_memmachine.resource_manager
    )
